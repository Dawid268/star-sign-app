async function seedProducts() {
  const products = [
    ...
    },
    {
      ...
      symbol: '🕯️',
      tag: 'Nowość',
      description: 'Ręcznie robiona świeca sojowa z intencją spokoju.',
    },
    {
      ...
      symbol: '🃏',
      tag: 'Zestaw',
      description: 'Klasyczna talia kart tarota wraz z przewodnikiem.',
    },
    {
      ...
      symbol: '🌙',
      description:
        'Srebrny naszyjnik (próba 925) przedstawiający fazy księżyca.',
    },
    {
      ...
      tag: 'Bestseller',
      description:
        'Pęczek białej szałwii do rytualnego oczyszczania przestrzeni.',
    },
  ];
  ...
  for (const product of products) {
    try {
      ...
      console.error(
        `Nie udało się zasiać produktu ${product.name}:`,
        error.message,
      );
    }
  }
